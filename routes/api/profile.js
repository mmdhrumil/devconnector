...
// @description Test route for getting current user's profile
// @access Private
...
router.get('/user/:user_id', async (req, res) => {
    try{
        ...
        profile = await Profile.findOne({ user: req.params.user_id}).populate('user',
        ['name','avatar']);
...
async (req, res) => {
    ...
    const {school, degree, fieldOfStudy,
    from, to, current, description} = req.body;
